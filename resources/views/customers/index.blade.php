...
@section('content')
    <div class="main-content__top">
        ...
        <a href="{{ route('customers.create') }}" class="link create-link">
    ...
    <table class="table-auto">
        <thead>
            <tr>
                ...
                <th class="px-4 py-2">Numéro TVA</th>
        ...
        <tbody>
            @foreach ($customers as $customer)
                <tr>
                    <td class="border px-4 py-2">{{ $customer->reference }}</td>
                    <td class="border px-4 py-2">{{ $customer->name }}</td>
                    <td class="border px-4 py-2">{{ $customer->email }}</td>
                    <td class="border px-4 py-2">{{ $customer->phone }}</td>
                    <td class="border px-4 py-2">{{ $customer->website }}</td>
                    <td class="border px-4 py-2">{{ $customer->vat_number }}</td>
                    <td class="border px-4 py-2">{{ $customer->description }}</td>
                    <td class="border px-4 py-2">{{ $customer->comment }}</td>
